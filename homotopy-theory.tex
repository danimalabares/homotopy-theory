...
\end{tikzcd}\]
%\begin{tikzcd}[row sep=large]
%	{\color{red}A_i}\arrow[r]\arrow[d,red,"\Lc\ni\ell_i",swap]&\coprod A_i\arrow[d]\arrow[r]&{\color{red}\bullet}\arrow[d,"r\in\Rc"]\\
%	{\color{red}B_i}\arrow[r,red]\arrow[rru]&{\color{red}\coprod B_i}\arrow[r]\arrow[ur,dashed,red]&\bullet
%\end{tikzcd}\]
\end{proof}
...
\begin{defn}[\textit{May}]\leavevmode
	\begin{enumerate}
...
\end{thm}
\begin{thm}[Whitehead, \textit{May}]\label{thm:W2}
