...
For the proof of long exact homotopy sequence see theorem 4.3 in Hatcher. I couldn't properly explain the last paragraph
...
\end{itemize}
\section{the right category to work at}
\begin{itemize}
