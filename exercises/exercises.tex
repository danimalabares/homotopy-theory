...
ow, again by the \href{https://en.wikipedia.org/wiki/Universal_coefficient_theorem#Universal_coefficient_theorem_for_cohomology}{universal coefficient theorem for cohomology} we have a short exact sequence
\[\begin{tikzcd}
